...
def main():
    ...
    # model training
    parser.add_argument('--epoch', type=int, default=10, help='number of epochs to search')
    parser.add_argument('--retrain_epoch', type=int, default=10, help='number of epochs to retrain')
    ...
    dataloaders, data_indices, out_features = get_data(G, task=task, labels=labels, args=args, logger=logger)
    print("The type of labels is: {}".format(out_features))
